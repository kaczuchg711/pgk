...
light_source {
  <10, 3, 142.5>  
  color rgb<1-clock/60,1-clock/60,1-clock/60>  
  translate <0,clock/2, 0>
}

light_source {
  <0,100,0>  
  color rgb<clock/60,clock/60,clock/60>  
}
...
sphere {
  <10, 3, 147.5>, 3 // <x, y, z>, radius
  pigment {color rgb<1,1,0>}
  translate <0,clock/2, 0> // <x, y, z>
}
